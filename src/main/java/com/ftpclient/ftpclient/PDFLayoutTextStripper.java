    ...
    private void writeLine(final List<TextPosition> textPositionList) {
        if (textPositionList.size() > 0) {
            ...
            for (TextPosition textPosition : textPositionList) {
                ...
                Character character = characterFactory.createCharacterFromTextPosition(
                        textPosition, this.getPreviousTextPosition());
...
class CharacterFactory {
    ...
    public Character createCharacterFromTextPosition(final TextPosition textPosition,
        ...
        int index = (int) textPosition.getX()
                / PDFLayoutTextStripper.OUTPUT_SPACE_CHARACTER_WIDTH_IN_PT;
        return new Character(character, index, isCharacterPartOfPreviousWord,
                isFirstCharacterOfAWord, isCharacterAtTheBeginningOfNewLine,
    ...
    private boolean isFirstCharacterOfAWord(final TextPosition textPosition) {
        ...
        double numberOfSpaces = this.numberOfSpacesBetweenTwoCharacters(previousTextPosition,
                textPosition);
